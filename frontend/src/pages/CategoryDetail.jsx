...
import { ArrowLeft, Folder, Ticket, BookOpen, UserCircle } from 'lucide-react';
      ...
      <div className="grid grid-cols-3 gap-8">
        ...
        <div className="col-span-1">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-2xl font-bold" style={{ color: category.color }}>
                  {category._count?.knowledgeArticles || 0}
                </p>
        ...
        <div className="col-span-2">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="divide-y divide-gray-100">
              {category.knowledgeArticles && category.knowledgeArticles.length > 0 ? (
                category.knowledgeArticles.map((article) => (
                  <div
                    key={article.id}
