...
/**
 * Gap/CFS Feature Page: `cannedResponses` lacks `/auto-generate-canned-response`.
 * Slug: cannedresponses-lacks-auto-generate-canned-response
 * Backend: /api/gap-cannedresponses-lacks-auto-generate-canned-response
 */
export default function CannedresponsesLacksAutoGenerateCannedResponsePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-cannedresponses-lacks-auto-generate-canned-response', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`cannedResponses` lacks `/auto-generate-canned-response`.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`cannedResponses` lacks `/auto-generate-canned-response`.</p>
