...
/**
 * Gap/CFS Feature Page: Multi-lingual support automation
 * Slug: multi-lingual-support-automation
 * Backend: /api/cf-multi-lingual-support-automation
 */
export default function MultiLingualSupportAutomationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-lingual-support-automation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Multi-lingual support automation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Auto-translate tickets/responses; route to bilingual agents.</p>
