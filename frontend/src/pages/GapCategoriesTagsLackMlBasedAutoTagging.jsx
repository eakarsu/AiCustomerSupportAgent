...
/**
 * Gap/CFS Feature Page: `categories`, `tags` lack ML-based auto-tagging.
 * Slug: categories-tags-lack-ml-based-auto-tagging
 * Backend: /api/gap-categories-tags-lack-ml-based-auto-tagging
 */
export default function CategoriesTagsLackMlBasedAutoTaggingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-categories-tags-lack-ml-based-auto-tagging', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`categories`, `tags` lack ML-based auto-tagging.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`categories`, `tags` lack ML-based auto-tagging.</p>
