...
/**
 * Gap/CFS Feature Page: Predictive customer churn
 * Slug: predictive-customer-churn
 * Backend: /api/cf-predictive-customer-churn
 */
export default function PredictiveCustomerChurnPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-customer-churn', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive customer churn</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Identify at-risk customers based on support interaction patterns; trigger proactive retention outreach.</p>
