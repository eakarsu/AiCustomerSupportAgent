...
/**
 * Gap/CFS Feature Page: Proactive support triggers
 * Slug: proactive-support-triggers
 * Backend: /api/cf-proactive-support-triggers
 */
export default function ProactiveSupportTriggersPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-proactive-support-triggers', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Proactive support triggers</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Monitor user activity/errors; suggest help articles before customer opens a ticket.</p>
